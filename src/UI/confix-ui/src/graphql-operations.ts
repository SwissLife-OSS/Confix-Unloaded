...
export type CreateApplicationMutation = { __typename?: 'Mutation', createApplication: { __typename?: 'CreateApplicationPayload', application?: Maybe<{ __typename?: 'Application', id: string, name: string, parts: Array<{ __typename?: 'ApplicationPart', id: string, name: string, components: Array<{ __typename?: 'ApplicationPartComponent', definition: { __typename?: 'Component', id: string, name: string } }> }> }> } };

export type AllAppsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllAppsQuery = { __typename?: 'Query', applications?: Maybe<{ __typename?: 'ApplicationConnection', edges?: Maybe<Array<{ __typename?: 'ApplicationEdge', node: { __typename?: 'Application', id: string, name: string, parts: Array<{ __typename?: 'ApplicationPart', id: string, name: string, components: Array<{ __typename?: 'ApplicationPartComponent', definition: { __typename?: 'Component', id: string, name: string } }> }> } }>> }> };

export type ApplicationFragment = { __typename?: 'Application', id: string, name: string, parts: Array<{ __typename?: 'ApplicationPart', id: string, name: string, components: Array<{ __typename?: 'ApplicationPartComponent', definition: { __typename?: 'Component', id: string, name: string } }> }> };

export type ComponentFragment = { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> };
...
export type CreateComponentMutation = { __typename?: 'Mutation', createComponent: { __typename?: 'CreateComponentPayload', component: { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> } } };

export type AllComponentsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllComponentsQuery = { __typename?: 'Query', components?: Maybe<{ __typename?: 'ComponentConnection', edges?: Maybe<Array<{ __typename?: 'ComponentEdge', node: { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> } }>> }> };
...
export type UpdateComponentSchemaMutation = { __typename?: 'Mutation', updateComponentSchema: { __typename?: 'UpdateComponentSchemaPayload', component: { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> } } };
...
export type UpdateComponentSchemaAndValuesMutation = { __typename?: 'Mutation', updateComponentSchema: { __typename?: 'UpdateComponentSchemaPayload', component: { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> } }, updateComponentValues: { __typename?: 'UpdateComponentValuesPayload', component: { __typename?: 'Component', id: string, name: string, state: ComponentState, schemaSdl?: Maybe<any>, schema?: Maybe<any>, values?: Maybe<any>, defaults?: Maybe<any>, schemaViolations: Array<{ __typename?: 'SchemaViolation', path: any, code: string }> } } };
...
export const UpdateComponentSchemaAndValuesDocument = gql`
    mutation updateComponentSchemaAndValues($values: UpdateComponentValuesInput!, $schema: UpdateComponentSchemaInput!) {
...
const UpdateComponentSchemaDocumentString = print(UpdateComponentSchemaDocument);
const UpdateComponentSchemaAndValuesDocumentString = print(UpdateComponentSchemaAndValuesDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createApplication(variables: CreateApplicationMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: CreateApplicationMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateApplicationMutation>(CreateApplicationDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createApplication');
    },
    allApps(variables?: AllAppsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: AllAppsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<AllAppsQuery>(AllAppsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'allApps');
    },
    createComponent(variables: CreateComponentMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: CreateComponentMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreateComponentMutation>(CreateComponentDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createComponent');
    },
    allComponents(variables?: AllComponentsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: AllComponentsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<AllComponentsQuery>(AllComponentsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'allComponents');
    },
    updateComponentSchema(variables: UpdateComponentSchemaMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: UpdateComponentSchemaMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateComponentSchemaMutation>(UpdateComponentSchemaDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateComponentSchema');
    },
    updateComponentSchemaAndValues(variables: UpdateComponentSchemaAndValuesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: UpdateComponentSchemaAndValuesMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdateComponentSchemaAndValuesMutation>(UpdateComponentSchemaAndValuesDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateComponentSchemaAndValues');
    }
  };
}
