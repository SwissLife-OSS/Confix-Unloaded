/**
 * @generated SignedSource<<96aa0b126f34666aa5a683d60d4d64db>>
...
export type GroupsList_Groups$data = {
  ...
  readonly " $fragmentType": "GroupsList_Groups";
};
export type GroupsList_Groups$key = {
  readonly " $data"?: GroupsList_Groups$data;
